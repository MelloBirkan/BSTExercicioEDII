...
public:
    ...
    void exibirFuncionariosPorIdade(int idadeMinima, void (*imprimir)(const Funcionario &)) const;
...
private:
    ...
    void percursoInOrderNo(No *no, std::function<void(const Funcionario &)> processar) const;
